...
// @Singleton ensure a single instance of a class globally. So, there will be only one
// DbHelper class instance for the app and whenever a class asks for DbHelper
// as a dependency, it will be provided with the same instance that is maintained
...
public class DbHelper extends SQLiteOpenHelper {
    ...
    //@Inject on the constructor instructs the Dagger to accumulate all the parameter
    // dependencies when the class is being constructed.
    @Inject
    public DbHelper(@Named("application_context") Context context,
                    @Named("string") String dbName,
                    @Named("integer") Integer version) {
    ...
    protected int getUsers() throws Resources.NotFoundException, NullPointerException {
        Cursor cursor = null;
        try {
            SQLiteDatabase db = this.getReadableDatabase();
            cursor = db.rawQuery(
